...
const {
  ...
  addItem,
  updateItem,
} = require("./mysqlConnection/items.js");
...
const {
  ...
  addCustomer,
  updateCustomer,
} = require("./mysqlConnection/customers.js");
const { allNumbers, phoneNumberRegex } = require("./regex/regex.js");
const {
  selectEmployeeByPassword,
  selectEmployees,
  selectEmployeeById,
  addEmployee,
  updateEmployee,
...
const {
  selectModsByItem,
  selectModsByItemDefault,
  selectModsById,
  addMod,
  updateMod,
} = require("./mysqlConnection/mods");
const {
  selectOrderById,
  ...
  updateInUse,
  deleteOrder,
} = require("./mysqlConnection/orders.js");
...
app.get("/items", async (req, res) => {
  try {
    const results = await selectAllItems();
    if (results) {
